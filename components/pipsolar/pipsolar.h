...
class Pipsolar : public uart::UARTDevice, public PollingComponent {
  ...
  PIPSOLAR_SWITCH(lcd_default_switch, QFLAG)
  PIPSOLAR_SWITCH(overload_restart_switch, QFLAG)
  PIPSOLAR_SWITCH(over_temperature_switch, QFLAG)
  PIPSOLAR_SWITCH(alarm_primary_interrupt_switch, QFLAG)
  PIPSOLAR_SWITCH(fault_record_switch, QFLAG)
